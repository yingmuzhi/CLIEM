...
Examples:
  ...
  python align_correct_background.py -i /path/to/images/ -o /path/to/output/ -t transformations.csv --verbose
    ...
    parser.add_argument(
        '--output-dir', '-o',
        type=str,
        default='/Volumes/T7/20251010_halfCell/preprocessedData_Part/part4_2_o',
    ...
    parser.add_argument(
        '--transformations', '-t',
        type=str,
        default='/Volumes/T7/20251010_halfCell/preprocessedData_Part/part4_2_Results.csv',
...
def apply_alignment_to_slices(image_data: np.ndarray, 
...
def process_directory(input_dir: str, output_dir: str, transformations_path: str, 
                     args, use_lzw: bool, verbose: bool, bit_depth: int):
    """Process all TIF files in a directory by stacking them and applying alignment."""
    try:
        ...
        print("Step 3: Loading Results.csv file...")
        transformations = load_results_csv(transformations_path, verbose=verbose)
        print(f"Loaded {len(transformations)} transformations from Results.csv")
        print()
        
        # Preprocess transformations
        print("Step 4: Preprocessing transformations...")
        preprocessed_transformations = preprocess_transformations(
            transformations, 
            args.threshold,
            args.drift_gap,
        ...
        corrected_csv_path = os.path.join(os.path.dirname(transformations_path), 'Results_changed.csv')
        print("Step 5: Saving corrected Results.csv...")
        save_corrected_results_csv(
            preprocessed_transformations, 
            corrected_csv_path, 
            verbose=verbose
        ...
        # Apply alignment to the 3D stack
        print("Step 6: Applying alignment to 3D stack...")
        aligned_slices = apply_alignment_to_slices(
            image_stack, 
            preprocessed_transformations, 
            verbose=verbose
        ...
        print("Step 7: Saving aligned slices as individual 2D TIF files...")
        successful_count = 0
