...
from Preprocess.delete_redundant_BG import delete_redundant_background
...
def build_parser() -> argparse.ArgumentParser:
    ...
    general.add_argument(
        "--base-dir",
        default="/Volumes/T7/20251010_halfCell/20251119_amira_o/2_seperate/bigCell",
    ...
    general.add_argument(
        "--delete-bg-output",
        default="/Volumes/T7/20251010_halfCell/preprocessedData_Part/7_deleteBG",
